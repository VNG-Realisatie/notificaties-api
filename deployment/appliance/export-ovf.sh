...
vboxmanage export ${VM_NAME} --output ${VM_NAME}.ovf --vsys 0 --product="Open Notificaties" --producturl="https://gith
ub.com/open-zaak/open-notificaties" --vendor="Maykin Media" --vendorurl="https://www.maykinmedia.nl" --version="1.0.0-alpha" --description="Open Notificaties is een modern en open source component voor het routeren van
berichten tussen componenten, systemen en applicaties."
